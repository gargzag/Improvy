...
class Model_Courses extends Model
{
	...
	{	
        ...
        $data = mysql_query("SELECT distinct `courses`.`id_course`,`courses`.`coursename_rus`, `courses`.`coursename_eng`, `courses`.`price`,`courses`.`description`, `courses`.`minprice`, `companies`.`id_company`,`companies`.`compname_rus`,`companies`.`compname_eng`,`venues`.`district`
                            FROM `courses` 
